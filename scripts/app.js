...
const formulario = document.getElementById("formulario_completo")

console.log("si esta pasando despues de las constantes");


formulario.addEventListener("submit", e=>{
  console.log("si esta entrando dentro de la event linetern antes de prevent default");
  e.preventDefault();

  console.log("si esta entrando dentro de la event linetern despues de prevent default");
  let adv = ""
